#include "common.h" // for useful data types
#include "chunk.h"  // for Chunk
#include "debug.h"  // for dissassembleChunk
#include "vm.h"     // use of VM
...
int main(int argc, const char* argv[]) {
    ...
    #if 0 // manual bytecode insertion
    Chunk chunk;
    initChunk(&chunk);
